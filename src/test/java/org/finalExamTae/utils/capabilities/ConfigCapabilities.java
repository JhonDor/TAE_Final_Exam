package org.finalExamTae.utils.capabilities;
...
/**
 * Class for set up the capabilities configuration, the data comes from an external file
 */
public class ConfigCapabilities {
    ...
    /**
     *this method does the initial setup of the application.
    ...
    /**
     * Method for get the needed data for the capabilities from a json file.
